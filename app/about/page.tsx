      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            ...
            <blockquote className="border-l-2 border-[#D8A83E] pl-5 font-body italic text-[#F5F5F2]/85 leading-relaxed">
          ...
          <div className="rounded-2xl border border-[#2C3138] bg-[#181B1E]/80 p-8">
            <div className="font-mono text-xs text-[#D8A83E] uppercase tracking-widest mb-6">
                ...
                return (
                  <li key={step.title} className="flex gap-5 pb-8 last:pb-0">
                    <div className="flex flex-col items-center">
                      <div className="w-10 h-10 rounded-lg border border-[#D8A83E]/40 bg-[#202428] flex items-center justify-center shrink-0">
                        <Icon className="w-5 h-5 text-[#D8A83E]" />
                      </div>
                      {idx < pipeline.length - 1 && (
                        <div className="w-px flex-1 bg-[#2C3138] my-2" />
                      )}
                    </div>
                    <div className="pt-1.5">
                      ...
                      <p className="font-body text-sm text-[#F5F5F2]/70 leading-relaxed">
                        {step.body}
                      </p>
                    </div>
                  </li>
        ...
        <div className="mt-16 rounded-2xl border border-[#D8A83E]/30 bg-gradient-to-br from-[#202428] to-[#14171A] p-10">
          <div className="flex items-start gap-4">
            <ShieldCheck className="w-6 h-6 text-[#D8A83E] shrink-0 mt-1" />
            <div>
              <h3 className="font-heading font-bold text-lg mb-2">Ethical & Legal Standards</h3>
              <p className="font-body text-sm text-[#F5F5F2]/75 leading-relaxed max-w-3xl">
