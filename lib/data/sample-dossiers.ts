...
export const SAMPLE_DOSSIERS: Record<string, DossierData> = {
  fmcg: {
    ...
    trend: [
      { label: "1 Aug", value: 34 },
      { label: "4 Aug", value: 52 },
      { label: "7 Aug", value: 78 },
      { label: "10 Aug", value: 121 },
      { label: "13 Aug", value: 176 },
      { label: "16 Aug", value: 214 },
      { label: "19 Aug", value: 258 },
      { label: "22 Aug", value: 298 },
  ...
  political: {
    ...
    trend: [
      { label: "14 Aug", value: 38 },
      { label: "17 Aug", value: 41 },
      { label: "20 Aug", value: 39 },
      { label: "23 Aug", value: 47 },
      { label: "26 Aug", value: 52 },
      { label: "29 Aug", value: 61 },
      { label: "1 Sep", value: 66 },
      { label: "4 Sep", value: 58 },
  ...
  fintech: {
    ...
    trend: [
      { label: "1 Aug", value: 42 },
      { label: "5 Aug", value: 51 },
      { label: "9 Aug", value: 48 },
      { label: "13 Aug", value: 63 },
      { label: "17 Aug", value: 72 },
      { label: "21 Aug", value: 84 },
      { label: "25 Aug", value: 79 },
      { label: "29 Aug", value: 92 },
